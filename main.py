...
schedule.every().day.at('20:00').do(notice.gomi_check_and_message)
schedule.every().day.at('20:30').do(notice.gomi_check_and_message)
schedule.every().day.at('21:00').do(notice.gomi_check_and_message)
